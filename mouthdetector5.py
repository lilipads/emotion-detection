...
for j in range(numtrain):
	train_data[j] = (trainarray[j][:]/134,trainlabels[j])

detector = net.Net([dimtrain, 2])
detector.train(train_data, 100, 10, 0.3)

np.save('/Users/kimducksoo/Desktop/CS51final/weights3',detector.weights)
np.save('/Users/kimducksoo/Desktop/CS51final/biases3',detector.biases)
