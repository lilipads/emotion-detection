...
weights = np.load('/Users/kimducksoo/Desktop/CS51final/weights2.npy')
biases = np.load('/Users/kimducksoo/Desktop/CS51final/biases2.npy')
...
for j in range(numtest):
	test_data[j] = (testarray[j][:]/225,testlabels[j])

detector = net.Net([280, 15, 2])
