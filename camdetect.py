...
realtestarray = np.genfromtxt("/Users/kimducksoo/Desktop/CS51final/camtest.csv", dtype=float, delimiter=',')
testgroup = np.genfromtxt("/Users/kimducksoo/Desktop/CS51final/camgroup.csv", dtype=float, delimiter=',')
...
weights = np.load('/Users/kimducksoo/Desktop/CS51final/weights.npy')
biases = np.load('/Users/kimducksoo/Desktop/CS51final/biases.npy')
